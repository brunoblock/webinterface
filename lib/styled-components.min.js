/* version 3.3.0, update from https://unpkg.com/styled-components@3.3.0/dist/styled-components.min.js */
...
const
  ...
  consolidateStreamedStyles = StyledComponents.consolidateStreamedStyles,
...
// custom stylis functions
import plugins from '/stylis-plugins.js'

Object.keys(plugins).forEach(name => {
  stylis.use(plugins[name])
})
